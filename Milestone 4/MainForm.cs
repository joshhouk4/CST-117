...
namespace Inventory_Management_System
{
    public partial class MainForm : Form
    {
        ...
        List<string> prodIdList = new List<string>();                                                 //List to store Part Numbers
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            prodIdList.Add(partNumberTextBox.Text);                                               //Add Part Number to list (used for search and index)
        ...
        private void searchButton_Click(object sender, EventArgs e)
        {
            ...
            if (searchTextBox.Text != "" && nameList.Count > 0)                                   //Make sure there is data in the texbox and an item in the list
            {
                ...
                for (int x = 0; x < prodIdList.Count; x++)                                        //Check all the values in the Part Number list
                {
